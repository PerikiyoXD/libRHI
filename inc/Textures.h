...
namespace maple
{
	...
	public:
		...
		virtual auto buildTexture(TextureFormat internalformat, uint32_t width, uint32_t height, bool srgb = false, bool depth = false, bool samplerShadow = false, bool mipmap = false, bool image = false, uint32_t accessFlag = 0) -> void override
		{}
		...
		virtual auto generateMipmaps(const CommandBuffer* cmd) -> void override = 0;
